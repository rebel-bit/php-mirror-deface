...
<html lang="en">
  <head>  
    ...
    <link rel="stylesheet" href="https://rebel-bit.github.io/assets/flash.css">
      ...
      <div class="main-content">
         <div class="page-content">
           <div class="container-fluid">            
            ...
            <h5 class="h4 card-title  mb-2"> Legend</h5>
            </div>
            <div class="card-body">
            ...
            $row3 = $q3->fetchArray();
            $q4 = $db->query("SELECT COUNT(*) FROM mirror INNER JOIN user ON mirror.defacer = user.user_id WHERE user.username = '$userc' AND mirror.status = '1'");
            $row4 = $q4->fetchArray();
            $totaldefaceuser = $row1[0];
            $totaldefaceuserhome = $row2[0];
            $totaldefaceuserspec = $row3[0];
            $onhold = $row4[0];
            echo "<td>$i.</td><td colspan=\"2\"><a href=\"attacker.php?name=$alias\">$username</a></td><td>$totaldefaceuserhome</td><td >$totaldefaceuserspec</td><td>$onhold</td><td>$totaldefaceuser</td>
            ";
            $i++;
            echo "</tr>";
            } // while
            ...
            <div class="card">
            <div class="card-header">
            <h5 class="h4 card-title  mb-2"> Top defacer</h5>
            </div>
            <div class="card-body">
            <div class="table-responsive">
            <table class="table text-success">
            ...
            <div class="card">
            <div class="card-header">
            <h5 class="h4 card-title  mb-2"> Top team</h5>
            </div>
            <div class="card-body">
            <div class="table-responsive">
            <table class="table text-success">
           ...
           $row3 = $q3->fetchArray();
           $q4 = $db->query("SELECT COUNT(*) FROM mirror INNER JOIN team ON mirror.team = team.team_id WHERE team.team_id = '$teamid' AND mirror.status = '1'");
           $row4 = $q4->fetchArray();
           ...
           $onhold = $row4[0];
           if ($teamid > "0") {
           echo "<td>$i.</td><td colspan=\"2\"><a href=\"team.php?name=$alias\">$teamname</a></td><td>$totaldefaceteamhome</td><td>$totaldefaceteamspec</td><td>$onhold</td><td>$totaldefaceteam</td>
           ";
           $i++;
           }echo "</tr>";
           } // while
           ...
           ?>
            ...
            <div class="card">
            <div class="card-header">
            <h5 class="h4 card-title  mb-2">Recent Special</h5>
            </div>
            <div class="card-body">
            <div class="table-responsive">
            <table class="table text-success">
            ...
            <tbody>
            <?php
            $q = $db->query("SELECT * FROM mirror LEFT JOIN team ON mirror.team = team.team_id INNER JOIN user ON mirror.defacer = user.user_id WHERE mirror.special = '1' and mirror.status = '0' ORDER BY date DESC LIMIT 0,10");
            ...
            $mirrorshow = "<span class=\"badge badge-primary\" style=\"font-weight:bold; color:white\"><i class=\"fa fa-desktop\" style=\"color:white;\" aria-hidden=\"true\"> View</span>";
            $date = $row['date'];
            $ip = $row['ip'];
            ...
            <div class="card">
            <div class="card-header">
            <h5 class="h4 card-title  mb-2">Recent Onhoald</h5>
            </div>
            <div class="card-body">
            <div class="table-responsive">
            <table class="table text-success">
            ...
            <tbody>
            <?php
            $q = $db->query("SELECT * FROM mirror LEFT JOIN team ON mirror.team = team.team_id INNER JOIN user ON mirror.defacer = user.user_id WHERE mirror.special = '0' and mirror.status = '0' ORDER BY date DESC LIMIT 0,10");
