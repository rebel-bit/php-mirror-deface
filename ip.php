                  ...
                  <div class="card-body">
                    <div class="d-flex">
                      ...
                      <div class="flex-shrink-0 align-self-center ">
                       ...
                       <h5 class="h4 card-title  text-success mb-2"> Found <? echo $num.' Website For '.$ip; ?></h5>
                       </div>
                       <div class="card-body">
                       <center>
                       ...
                       $neg = $page - 1;
                       $pos = $page + 1;
                       if($page == 1){echo '<li class="page-item disabled" ><a class="page-link" disabled="disabled" href="#">Previous</a></li>';}
                       else{echo '<li class="page-item"><a class="page-link" href="?name='.$attacker.'&page='.$neg.'">Previous</a></li>';}
                       
                       echo '<li class="page-item active"><a class="page-link" href="" >'.$page.'</a></li>';
                       
                       if($page == $coun){echo '<li class="page-item disabled"><a  class="page-link" disabled="disabled" onClick="page()">Next</a></li>';}
                       else{echo '<li class="page-item"><a class="page-link" href="?name='.$_GET['name'].'&page='.$pos.'" >Next</a></li>';}
                       ?>
                       </ul>
                       </div> 
                       </div>
