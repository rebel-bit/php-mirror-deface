                  ...
                  <div class="card-body">
                    <div class="d-flex">
                      ...
                      <div class="flex-shrink-0 align-self-center ">
                        ...
                        <div class="card">
                        <div class="card-header">
                        <h5 class="h4 card-title  text-success mb-2"> Team Ranking</h5>
                        </div>
                        <div class="card-body">
                        <center>
                        <div class="table-responsive pt-3 table-striped">
                        ...
                        $q = $db->query("SELECT *,COUNT(*) FROM mirror INNER JOIN team ON mirror.team = team.team_id GROUP BY mirror.team ORDER BY COUNT(*) DESC LIMIT $hal, $sort");
                        echo "<tr>";
                        $i = $sort * $page;
                        if ($curpage == 0) {
                        $i = $curpage+1;
