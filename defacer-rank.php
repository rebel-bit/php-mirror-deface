                  ...
                  <div class="card-body">
                    <div class="d-flex">
                      ...
                      <div class="flex-shrink-0 align-self-center ">
                       ...
                       <h5 class="h4 card-title  text-success mb-2"> Statistik</h5>
                       </div>
                       <div class="card-body">
                       <center>
                       ...
                       <div class="card">
                       <div class="card-header">
                       <h5 class="h4 card-title mdi mdi-guy-fawkes-mask text-success mb-2"> Defacer Ranking</h5>
                       </div>
                       <div class="card-body">
                       <center>
                       <div class="table-responsive pt-3 table-striped">
                       ...
                       $sort = 10;
                       $hal = $sort * $curpage;
                       $sel = $db->query("SELECT *,COUNT(*) FROM mirror INNER JOIN user ON mirror.defacer = user.user_id GROUP BY mirror.defacer ORDER BY COUNT(*) DESC");
                       $num = 0;
                       while($rw = $sel->fetchArray()){$num++;}
                       $coun = round($num / $sort);
                       if($page>$coun){$page=$coun;}
                       
                       
                       $q = $db->query("SELECT *,COUNT(*) FROM mirror INNER JOIN user ON mirror.defacer = user.user_id GROUP BY mirror.defacer ORDER BY COUNT(*) DESC LIMIT $hal, $sort");
                       echo "<tr>";
                       $i = $sort * $page;
                       if ($curpage == 0) {
                       $i = $curpage+1;
