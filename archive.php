    ...
    <div id="layout-wrapper">
      ...
      <div class="main-content">
         <div class="page-content">
           ...
           <div class="card">
           <div class="card-header">
           <h5 class="h4 card-title  text-success mb-2"> Recent Archive</h5>
           </div>
           <div class="card-body">
           <center>
           <div class="table-responsive pt-3 table-striped">
           ...
           $sort = 20;
           $hal = $sort * $curpage;
           $sel = $db->query("SELECT * FROM mirror LEFT JOIN team ON mirror.team = team.team_id INNER JOIN user ON mirror.defacer = user.user_id WHERE mirror.status = '0' ORDER BY date DESC");
           $num = 0;
           ...
           // Db Select
           $q = $db->query("SELECT * FROM mirror LEFT JOIN team ON mirror.team = team.team_id INNER JOIN user ON mirror.defacer = user.user_id WHERE mirror.status = '0' ORDER BY date DESC LIMIT $hal, $sort");
           echo "<tr>";
           $i = 1;
