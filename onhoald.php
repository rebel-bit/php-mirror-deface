                  ...
                  <div class="card-body">
                    <div class="d-flex">
                      ...
                      <div class="flex-shrink-0 align-self-center ">
                        ...
                        <h5 class="h4 card-title  text-success mb-2"> Recent Onhold</h5>
                        </div>
                        <div class="card-body">
                        <center>
                        ...
                        // Db Select
                        $q = $db->query("SELECT * FROM mirror LEFT JOIN team ON mirror.team = team.team_id INNER JOIN user ON mirror.defacer = user.user_id WHERE mirror.special = '0' and mirror.status = '1' ORDER BY date DESC LIMIT $hal, $sort");
                        echo "<tr>";
                        $i = 1;
